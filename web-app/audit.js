import {buildTelecallerDashboardBlob} from "./dashboard-export.js?v=5.2.43";
import {STATUS_HISTORY_PROMPT} from "./debug-prompts.js?v=5.2.43";

export const APP_VERSION = "5.2.43";
