import {buildTelecallerDashboardBlob} from "./dashboard-export.js?v=8.0.1.kpi-fix";
import {buildDashboardModel} from "./dashboard-metrics.js?v=8.0.1.kpi-fix";
import {STATUS_HISTORY_PROMPT} from "./debug-prompts.js?v=8.0.1.kpi-fix";
import {apiBase} from "./app-base.js?v=8.0.1.kpi-fix";

export const APP_VERSION = "8.0.1.kpi-fix";
