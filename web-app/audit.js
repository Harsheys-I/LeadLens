import {buildTelecallerDashboardBlob} from "./dashboard-export.js?v=3.5.1";
...
const CACHE_HANDBOOK = `LeadLens QA v3.5.1 — stable cacheable auditor handbook. Evidence only. Never invent facts, dates, budgets, locations, or prior calls.
