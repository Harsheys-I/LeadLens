import {buildTelecallerDashboardBlob} from "./dashboard-export.js?v=5.0.0";
...
const CACHE_HANDBOOK = `LeadLens QA v5.0.0 — stable cacheable auditor handbook. Evidence only. Never invent facts, dates, budgets, locations, or prior calls.
