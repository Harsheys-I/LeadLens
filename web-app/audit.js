import {buildTelecallerDashboardBlob} from "./dashboard-export.js?v=6.3.3.stable";
import {buildDashboardModel} from "./dashboard-metrics.js?v=6.3.3.stable";
import {STATUS_HISTORY_PROMPT} from "./debug-prompts.js?v=6.3.3.stable";
import {apiBase} from "./app-base.js?v=6.3.3.stable";

export const APP_VERSION = "6.3.3.stable";
