...
import {SalesGraphApi} from "./api-client.js?v=7.0.0.dev";
...
import {parseSalesGraphSheet, buildSalesGraphPayload} from "./sales-graph-parse.js?v=7.0.0.dev";
import {renderSalesGraphDashboard, destroySalesGraphCharts} from "./sales-graph-dashboard.js?v=7.0.0.dev";
...
const RELEASE_NOTES = "v7.0.0.dev: TeleCaller Performance overdue now compares Next Followup Date against tomorrow (NFD today counts as overdue).";
