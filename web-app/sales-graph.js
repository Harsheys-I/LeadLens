 ...
 */
import {APP_VERSION} from "./audit.js?v=6.0.7.dev";
import {requireAuth, logout, hasPermission, getUser, changePassword, updateProfile} from "./auth.js?v=6.0.7.dev";
import {SalesGraphApi} from "./api-client.js?v=6.0.7.dev";
import {mountNotifications} from "./notifications-ui.js?v=6.0.7.dev";
import {appUrl, homePath} from "./app-base.js?v=6.0.7.dev";
import {initTheme} from "./theme.js?v=6.0.7.dev";
import {setStorageUserId, storageKey} from "./db.js?v=6.0.7.dev";
import {parseSalesGraphSheet, buildSalesGraphPayload} from "./sales-graph-parse.js?v=6.0.7.dev";
import {renderSalesGraphDashboard, destroySalesGraphCharts} from "./sales-graph-dashboard.js?v=6.0.7.dev";
...
const RELEASE_NOTES = "v6.0.7.dev: Shorter hero Sales Graph charts; bar values labeled above each series (skip zeros when dense).";
