...
import {renderReviewDashboard,destroyReviewDashboard} from "./dashboard-view.js?v=5.4";
...
import {mountPerfReportUpload,mountPerfPublishedDashboard,refreshPerfPublished} from "./perf-dashboard.js?v=5.4";
