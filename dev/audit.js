import {buildTelecallerDashboardBlob} from "./dashboard-export.js?v=7.0.0.dev";
import {buildDashboardModel} from "./dashboard-metrics.js?v=7.0.0.dev";
import {STATUS_HISTORY_PROMPT} from "./debug-prompts.js?v=7.0.0.dev";
import {apiBase} from "./app-base.js?v=7.0.0.dev";

export const APP_VERSION = "7.0.0.dev";
