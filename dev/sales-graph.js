...
import {SalesGraphApi} from "./api-client.js?v=7.1.0.dev";
...
import {parseSalesGraphSheet, buildSalesGraphPayload} from "./sales-graph-parse.js?v=7.1.0.dev";
import {renderSalesGraphDashboard, destroySalesGraphCharts} from "./sales-graph-dashboard.js?v=7.1.0.dev";
...
const RELEASE_NOTES = "v7.1.0.dev: Team Forms templates vs snapshot tasks, Assign To/Status/Reviewer system fields, URL/document uploads, number-only fields, Admin user dept/group checkboxes.";
