...
import {SalesGraphApi} from "./api-client.js?v=7.1.1.dev";
...
import {parseSalesGraphSheet, buildSalesGraphPayload} from "./sales-graph-parse.js?v=7.1.1.dev";
import {renderSalesGraphDashboard, destroySalesGraphCharts} from "./sales-graph-dashboard.js?v=7.1.1.dev";
...
const RELEASE_NOTES = "v7.1.1.dev: Team Forms Task Builder under Form Builder — pick a template and create snapshot tasks (Assign To, Status, Reviewer + custom fields).";
