import {buildTelecallerDashboardBlob} from "./dashboard-export.js?v=7.2.1.dev";
import {buildDashboardModel} from "./dashboard-metrics.js?v=7.2.1.dev";
import {STATUS_HISTORY_PROMPT} from "./debug-prompts.js?v=7.2.1.dev";
import {apiBase} from "./app-base.js?v=7.2.1.dev";

export const APP_VERSION = "7.2.1.dev";
